...
const (
	Payment_GetPaymentUrl_FullMethodName = "/payment.Payment/GetPaymentUrl"
)
...
func (c *paymentClient) GetPaymentUrl(ctx context.Context, in *GetPaymentUrlRequest, opts ...grpc.CallOption) (*GetPaymentUrlResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPaymentUrlResponse)
	err := c.cc.Invoke(ctx, Payment_GetPaymentUrl_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPaymentServer) GetPaymentUrl(context.Context, *GetPaymentUrlRequest) (*GetPaymentUrlResponse, error) {
...
func _Payment_GetPaymentUrl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPaymentUrlRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServer).GetPaymentUrl(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Payment_GetPaymentUrl_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServer).GetPaymentUrl(ctx, req.(*GetPaymentUrlRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Payment_GetPaymentUrl_Handler,
		},
	},
